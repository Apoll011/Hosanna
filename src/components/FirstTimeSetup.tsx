    ...
    <div className="fixed inset-0 bg-m3-bg dark:bg-m3-dark-bg z-50 flex flex-col items-center justify-center p-6 text-center select-none overflow-y-auto">
      <div className="w-full max-w-sm space-y-6 animate-scale-up">
        <div className="flex justify-center mb-6">
          <img src="/logo.png" className="w-24 h-24 rounded-3xl shadow-xl border border-m3-border/20" alt="Hosanna" />
        </div>
        ...
        <p className="text-sm text-m3-secondary dark:text-m3-dark-secondary leading-relaxed">
          Para sincronizar os cânticos e planos do seu grupo de louvor, escaneie o código QR de acesso fornecido pelo líder.
        </p>
        ...
        <div className="bg-m3-card dark:bg-m3-dark-card border border-m3-border dark:border-m3-dark-border rounded-3xl overflow-hidden shadow-2xl mx-auto w-full max-w-[280px] aspect-square relative flex items-center justify-center">
          {hasCameraPermission === false ? (
            <div className="p-6 text-center space-y-3">
              ...
              <p className="text-xs font-bold text-m3-text dark:text-m3-dark-text">Câmera Bloqueada</p>
              <p className="text-[10px] text-m3-secondary">Permita o acesso à câmera para escanear o código QR.</p>
            </div>
          ) : (
