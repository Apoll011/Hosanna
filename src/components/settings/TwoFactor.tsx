...
export const TwoFactorSection: React.FC<TwoFactorSectionProps> = ({
    ...
    const handleFinishSetup = async () => {
        showToast(
            "Autenticação em 2 Etapas configurada com sucesso!",
            "success",
        );
        await refetchAuth();
        closeModal();
            ...
            <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-m3-secondary dark:text-m3-dark-secondary mt-0.5 leading-snug">
                        Adicione uma camada extra de segurança com código
                        temporário TOTP.
                    </p>
                </div>
                <button
            ...
            >
                <div className="space-y-4 py-2">
                    ...
                    {step === "setup" && (
                        <div className="space-y-3">
                            <p className="text-xs text-m3-secondary dark:text-m3-dark-secondary leading-relaxed">
                                1. Digitalize o código QR com a sua aplicação de
                                autenticação (Google Authenticator, Authy,
                            ...
                            <p className="text-xs text-m3-secondary dark:text-m3-dark-secondary leading-relaxed">
                                2. Introduza o código de 6 dígitos gerado pela
                                aplicação:
                            </p>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-amber-50 dark:bg-amber-950/30 p-3 rounded-xl border border-amber-200 dark:border-amber-900/50 flex gap-2.5">
                                ...
                                <p className="text-[11px] text-amber-800 dark:text-amber-400 leading-snug">
                                    Guarde estes códigos de recuperação num
                                    local seguro. Eles são a única forma de
                                    recuperar o acesso caso perca o telemóvel.
                                </p>
                            </div>
