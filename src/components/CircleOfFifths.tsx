...
const circleData = [
    {
        major: "C",
        minor: "Am",
        degrees: ["C", "Dm", "Em", "F", "G", "Am", "Bdim"],
    },
    {
        major: "G",
        minor: "Em",
        degrees: ["G", "Am", "Bm", "C", "D", "Em", "F#dim"],
    },
    {
        major: "D",
        minor: "Bm",
        degrees: ["D", "Em", "F#m", "G", "A", "Bm", "C#dim"],
    },
    {
        major: "A",
        minor: "F#m",
        degrees: ["A", "Bm", "C#m", "D", "E", "F#m", "G#dim"],
    },
    {
        major: "E",
        minor: "C#m",
        degrees: ["E", "F#m", "G#m", "A", "B", "C#m", "D#dim"],
    },
    {
        major: "B",
        minor: "G#m",
        degrees: ["B", "C#m", "D#m", "E", "F#", "G#m", "A#dim"],
    },
    {
        major: "Gb",
        minor: "Ebm",
        degrees: ["Gb", "Abm", "Bbm", "Cb", "Db", "Ebm", "Fdim"],
    },
    {
        major: "Db",
        minor: "Bbm",
        degrees: ["Db", "Ebm", "Fm", "Gb", "Ab", "Bbm", "Cdim"],
    },
    {
        major: "Ab",
        minor: "Fm",
        degrees: ["Ab", "Bbm", "Cm", "Db", "Eb", "Fm", "Gdim"],
    },
    {
        major: "Eb",
        minor: "Cm",
        degrees: ["Eb", "Fm", "Gm", "Ab", "Bb", "Cm", "Ddim"],
    },
    {
        major: "Bb",
        minor: "Gm",
        degrees: ["Bb", "Cm", "Dm", "Eb", "F", "Gm", "Adim"],
    },
    {
        major: "F",
        minor: "Dm",
        degrees: ["F", "Gm", "Am", "Bb", "C", "Dm", "Edim"],
    },
];
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 no-scrollbar pb-24 flex flex-col items-center">
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 my-4 select-none shrink-0 aspect-square">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    <span className="text-3xl font-black text-m3-primary dark:text-m3-dark-primary">
                        {selectedData.major}
                    </span>
                    <span className="text-sm font-bold text-m3-secondary dark:text-m3-dark-secondary mt-1">
                        {selectedData.minor}
                    </span>
                </div>
            </div>
            ...
            <div className="w-full max-w-sm mt-8 space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                    {selectedData.degrees.map((chord, i) => (
                        ...
                        >
                            <span
                                className={`text-[10px] font-bold opacity-70 mb-1 ${i === 0 || i === 5 ? "uppercase tracking-widest" : ""}`}
                            >
                                {i === 0
                                    ? "Tónica"
                                    : i === 5
                            ...
                            <span
                                className={`font-black ${i === 0 || i === 5 ? "text-xl" : "text-base"}`}
                            >
                                {chord}
                            </span>
                        </div>
