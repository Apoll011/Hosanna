...
export default function SongEditor({ songId, onClose }: SongEditorProps) {
    ...
    const existingFile = songId
        ? virtualFiles.find((f) => f.path === songId)
        : null;
        ...
        if (existingSong && existingFile) {
            ...
            const bodyLines = lines.filter((line) => {
                ...
                const isMeta =
                    ...
                    trimmed.startsWith("{song_number:") ||
                    trimmed.startsWith("{number:") ||
                    trimmed.startsWith("{youtube:") ||
                    trimmed.startsWith("{yt:") ||
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 no-scrollbar">
                ...
                <div className="bg-m3-card dark:bg-m3-dark-card p-4 rounded-2xl border border-m3-border/40 dark:border-m3-dark-border/40 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="text-[10px] text-m3-secondary dark:text-m3-dark-secondary font-bold">
                                Título *
                            </label>
                            <input
                                type="text"
                ...
                <div className="space-y-1">
                    <span className="text-[10px] font-bold text-m3-secondary dark:text-m3-dark-secondary">
                        Inserir Diretivas ChordPro Rápidas:
                    </span>
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: bodyText
                                    ...
                                    .replace(
                                        /(\[.*?\])/g,
                                        '<span class="text-m3-primary dark:text-m3-dark-primary font-bold bg-m3-primary-light/10 dark:bg-m3-dark-primary-light/10 rounded px-0.5">$1</span>',
                                    )
                                    .replace(
                                        /(\{(.*?)\})/g,
                                        '<span class="text-m3-secondary dark:text-m3-dark-secondary italic opacity-80">$1</span>',
                                    ),
                            }}
                        />
