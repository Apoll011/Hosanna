                    ...
                    >
                        ...
                        <div className="p-6 border-b border-m3-border/30 dark:border-m3-dark-border/30 bg-m3-sidebar dark:bg-m3-dark-sidebar flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <img
                                    src="/logo.png"
                                    className="w-10 h-10 rounded-xl border border-m3-border/20 shadow-xs object-cover"
                                    alt="Hosanna"
                                    referrerPolicy="no-referrer"
                                />
                                <div>
                                    <h2 className="text-base font-black text-m3-primary dark:text-m3-dark-primary tracking-tight leading-none">
                                        Hosanna
                                    </h2>
                                    <p className="text-[9px] text-m3-secondary dark:text-m3-dark-secondary font-medium mt-1">
                                        Menu
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1.5 no-scrollbar">
                            <div className="text-[9px] font-bold text-m3-secondary dark:text-m3-dark-secondary uppercase tracking-wider px-3 mb-1.5">
                                Biblioteca
                            </div>
